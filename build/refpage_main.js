...
function docNode(def2, list2, fStore) {
  ...
  for (let [input, port] of Object.entries(def2.inputs)) {
  ...
  for (let [output, port] of Object.entries(def2.outputs)) {
    const b = port.is("bus") ? ", bussed" : "";
    oRow.append(make(
      "td",
      {},
...
var nodesById = Object.groupBy(NODES, (x) => x.id);
var featuresByNodesUsing = {};
for (id of Object.keys(nodesById).sort()) {
